...
<table class="all-width-template">
    ...
    <tr>
        ...
        <td class="column-60 main-title-page" colspan="2">Для создания семестра заполните следующие данные и нажмите
            кнопку создать
        </td>
    ...
    <tr>
        <form action="/terms-create" method="post">
            ...
            <td class="column-45"><input type="text" name="duration" placeholder="24"></td>
            <td class="column-20"></td>
    </tr>
    <tr>
        <td class="column-7"></td>
    ...
    <tr>
        ...
        <td class="column-45 line-heigth-50"><input type="submit" value="Создать"></td>
        <td class="column-20"></td>
        </form>
    </tr>
</table>
